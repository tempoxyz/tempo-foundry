...
cast send 0xfeec000000000000000000000000000000000000 'mintWithValidatorToken(address,address,uint256,address)' 0x20C0000000000000000000000000000000000001 0x20C0000000000000000000000000000000000000 1000000000 0x6c4143BEd3A13cf9E5E43d45C60aD816FC091d0c --private-key "$PK" --rpc-url "$TEMPO_RPC_URL"

echo -e "\n=== ADD BetaUSD FEE TOKEN LIQUIDITY ==="
cast send 0xfeec000000000000000000000000000000000000 'mintWithValidatorToken(address,address,uint256,address)' 0x20C0000000000000000000000000000000000002 0x20C0000000000000000000000000000000000000 1000000000 0x6c4143BEd3A13cf9E5E43d45C60aD816FC091d0c --private-key "$PK" --rpc-url "$TEMPO_RPC_URL"

echo -e "\n=== ADD ThetaUSD FEE TOKEN LIQUIDITY ==="
cast send 0xfeec000000000000000000000000000000000000 'mintWithValidatorToken(address,address,uint256,address)' 0x20C0000000000000000000000000000000000003 0x20C0000000000000000000000000000000000000 1000000000 0x6c4143BEd3A13cf9E5E43d45C60aD816FC091d0c --private-key "$PK" --rpc-url "$TEMPO_RPC_URL"
