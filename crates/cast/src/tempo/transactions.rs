...
pub struct TempoTransactionReceiptWithRevertReason {
...
impl TempoTransactionReceiptWithRevertReason {
...
impl From<TempoTransactionReceipt> for TempoTransactionReceiptWithRevertReason {
    fn from(receipt: TempoTransactionReceipt) -> Self {
        Self { receipt, revert_reason: None }
    }
}

impl From<TempoTransactionReceiptWithRevertReason> for TempoTransactionReceipt {
    fn from(receipt_with_reason: TempoTransactionReceiptWithRevertReason) -> Self {
        receipt_with_reason.receipt
    }
}

impl UIfmt for TempoTransactionReceiptWithRevertReason {
...
impl UIfmt for TempoTransactionMaybeSigned {
    fn pretty(&self) -> String {
        match self {
...
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(untagged)]
pub enum TempoTransactionMaybeSigned {
    Signed {
        #[serde(flatten)]
        tx: TempoTxEnvelope,
        from: Address,
...
impl TempoTransactionMaybeSigned {
...
impl From<TempoTransactionRequest> for TempoTransactionMaybeSigned {
    fn from(tx: TempoTransactionRequest) -> Self {
        Self::new(WithOtherFields::new(tx))
    }
}

impl TryFrom<TempoTxEnvelope> for TempoTransactionMaybeSigned {
